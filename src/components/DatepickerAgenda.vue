      ...
      <div class="datepicker-body" :class="[classOrientation]">
        ...
        <div class="datepicker-month" v-for="month in months">
          <transition-group name="slidev">
            <div class="datepicker-month-label" v-for="month in [month]" :class="classDirection" :key="month">
              {{ month.getFormatted() }}
            </div>
          </transition-group>

          <div class="datepicker-week">
            <div class="datepicker-weekday" v-for="day in weekDays" track-by="$index">
              {{ day }}
            </div>
          </div>
          ...
          <div class="datepicker-days">
            <transition-group name="slidev">
              <div v-for="month in [month]" :class="classDirection" :key="month">
                ...
                <div class="datepicker-day" :class="{ selected: isSelected(day), today: isInitialDate(day), round: roundStyle}"
                     v-for="day in month.getDays()" @click="selectDate(day)" :disabled="isDisabled(day)">
                  <span class="datepicker-day-effect" :class="{ round: roundStyle }"></span>
